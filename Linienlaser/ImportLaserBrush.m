...
csvFiles = {'BU6981_2U_L.csv'};

brushDiameter = 150;  % brush outer diameter [mm]
resolution = 50;  % image output resolution [px/mm] (sensor: 200)

trimThresh = [906 22705];  % 0.95 for WSS, -1 for clicking, [x1 x2] for known 
filterSize = 100;  % median filter cell height

cutoffHeight = 1; % Symmetrical cutoff, values outside are set to this
lowerThreshold = 0.3; % Set values below this threshold to 0
